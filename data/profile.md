...
- Direct disagreement / handling conflict / changing your mind based on evidence / receiving pushback → Story 8
...
**8. Direct disagreement — peer review as a structured conflict-resolution process.**
Every paper I publish runs into reviewer pushback on methodology — across publications including the 2025 *Global Change Biology* paper and the 2024 *Oecologia* paper, both absorbed substantial reviewer-driven methodological revision. My default move is to treat the disagreement as an empirical question, not a position to defend: take the reviewer's proposed approach seriously, implement it alongside my own, and let the comparative result resolve the conflict. Resolutions go in both directions — I have rejected reviewer suggestions on solid empirical grounds, and I have adopted them when their alternative outperformed mine. When the empirical comparative does not settle it — usually because the conflict is rooted in underlying assumptions, not method — I deliberately seek two kinds of input from colleagues: someone with deep contextual understanding of the system (to catch nuance I might have missed), and someone abstracted from the conflict (to check whether my own assumptions are fogging my view, or whether I should actually be pushing back harder on my point). The goal is convergence on a defensible answer, not winning the argument.
